...
const EN_PORT = 3001;
const TR_PORT = 3002;
const EN_TARGET = `http://localhost:${EN_PORT}`;
const TR_TARGET = `http://localhost:${TR_PORT}`;
...
server.listen(PUBLIC_PORT, () => {
  ...
  startLocaleServer('en', EN_PORT, '.docusaurus-en');
  startLocaleServer('tr', TR_PORT, '.docusaurus-tr');
});